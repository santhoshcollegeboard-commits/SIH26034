...
For the given package image, extract these 9 fields:
1. product_name — The name of the product
2. manufacturer_name — Name of the manufacturer
3. manufacturer_address — Full address of the manufacturer
4. packer_name — Name of the packer (if different from manufacturer)
5. importer_name — Name of the importer (if applicable, for imported goods)
6. net_quantity — Net quantity/weight/volume declaration (e.g. "500 g", "1 L")
7. mrp — Maximum Retail Price including all taxes (e.g. "₹120.00", "MRP ₹85")
8. month_year_of_manufacture — Month and year of manufacture or packaging
9. consumer_care_details — Consumer care/helpline information (phone, email, address)
...
Return ONLY the JSON object with the 9 fields as keys. No extra commentary."""
